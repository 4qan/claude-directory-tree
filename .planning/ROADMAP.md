...
**Goal:** Users on Windows can run the scanner and get correct project discovery from Claude Code's project cache
**Requirements**: XPLAT-01, XPLAT-02, XPLAT-03, XPLAT-04
**Depends on:** Phase 4
**Success Criteria** (what must be TRUE):
  1. Windows-encoded project cache names decode to valid Windows drive paths
